...
const Section3 = () => {
    return (
        <section id="Services" className="w-full px-4 py-12 gap-16 flex flex-col relative lg:flex-row 2xl:gap-[160px] 2xl:p-20">
            <div className="hidden absolute left-0 -z-10 top-10 lg:block">    
                <img src={geometricFigure1} alt="decorative shape in purple in the shape of a circle" className="lg:h-[450px] xl:h-[600px] 2xl:h-auto"/>
            </div>   
            ...
            <div className="lg:flex lg:flex-col 2xl:h-[610px] 2xl:w-[1180px]">
                <div className="flex flex-col gap-6 text-center text-textColor lg:text-start lg:gap-3 2xl:gap-6">
                    <p className="text-textColorOther text-[16px] leading-[17.6px] font-medium lg:text-sm lg:leading-5 2xl:text-[20px] 2xl:leading-[22px]">Services</p>
                ...
                <div className="gap-12 flex flex-col items-center justify-center text-center lg:text-start">
                    ...
                    <div className="absolute left-0 bottom-20 -z-10 lg:top-0 lg:hidden">
            ...
            <div className="flex items-center justify-center md:justify-start lg:hidden 2xl:hidden">

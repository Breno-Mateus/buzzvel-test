...
const Section5 = () => {
    return (
        <section className="w-full bg-colorButton px-4 py-12 flex flex-col gap-16">

            <div className="flex flex-col items-center gap-6 text-center text-colorPrimary">
                <p className="text-colorButtonSecondary text-[16px] leading-[17.6px] font-medium">Join other Sun harvesters</p>
                <h1 className="text-[32px] leading-[35.2px] font-bold">Make something awesome</h1>
                <p className="text-[16px] leading-[22.4px] font-normal">Dui euismod iaculis libero, aliquet vitae et elementum porttitor. Eleifend mi tristique condimentum congue fusce nunc, donec magnis commodo.</p>

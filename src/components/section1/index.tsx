    ...
    return (
        ...
        2xl:p-20 2xl:gap-20">
            ...
            2xl:w-[600px]">
                ...
                2xl:text-[72px] 2xl:leading-[79.2px] 2xl:font-extrabold 2xl:text-start">Get the Sun to Power Your Home</h1>
                <p className="
                text-[18px] leading-[28.8px] font-normal text-center
                lg:text-start lg:text-base lg:leading-6
                2xl:text-[24px] 2xl:leading-[38.4px] 2xl:text-start">Viverra viverra nibh enim et aliquam, enim. Tempor, sit mus viverra orci dui consequat turpis scelerisque.</p>
            ...
            2xl:w-[600px]">
                ...
                lg:text-start lg:text-sm lg:leading-6

    ...
    return (
        <div className="flex flex-col items-center justify-between h-screen py-20 z-[1000] text-xl leading-6 font-medium tracking-[0.5px] text-textColor bg-colorPrimary">
            <div className="flex flex-col gap-8">
                <Link to="Products" smooth={true} duration={500} onClick={onClick}>Products</Link>
                <Link to="Solutions" smooth={true} duration={500} onClick={onClick}>Solutions</Link>
                <Link to="Services" smooth={true} duration={500} onClick={onClick}>Services</Link>
                <Link to="Configure" smooth={true} duration={500} onClick={onClick}>Configure</Link>
            </div>

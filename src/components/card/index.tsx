...
const Card = ({key, urlImage, text, name, consumption, className} : CardProps) => {
    return (
        ...
        lg:w-[193px] lg:h-[292px] lg:p-5
        xl:w-[243px] xl:h-[342px]
        2xl:w-[343px] 2xl:h-[442px] 2xl:p-8`} key={key}>
            <div className="text-textColor">
                <p className="
                text-[16px] leading-[22.4px] font-normal
                lg:text-xs lg:leading-2
                xl:leading-5
                ...
                <div className="flex mt-[38px] gap-4">
                    ...
                    <div className="flex flex-col">
                        ...
                        lg:text-xs lg:leading-2
                        xl:leading-5
                        2xl:text-[18px] 2xl:leading-[28.8px]lg:text-xs">{name}</p>
                        <p className="
